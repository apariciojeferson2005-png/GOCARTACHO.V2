...
public class SeguridadConfig {
    ...
    public SeguridadConfig(UserDetailsService userDetailsService, PasswordEncoder passwordEncoder,
            FiltroAutenticacionJwt jwtAuthFilter,
            com.gocartacho.gocartacho.security.OAuth2AuthenticationSuccessHandler oAuth2AuthenticationSuccessHandler) {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/planes/**", "/api/v1/planes-inteligentes/**")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/comercios/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/promociones/activas", "/api/v1/promociones/zona/**",
                                "/api/v1/promociones/**")
                        .permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/comercios/pendientes", "/api/v1/comercios/inactivos")
                        .hasRole(ROLE_ADMIN)
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/planes", "/api/v1/planes/**").hasRole(ROLE_ADMIN)
                        .requestMatchers(HttpMethod.PUT, "/api/v1/planes/**").hasRole(ROLE_ADMIN)
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/planes/**").hasRole(ROLE_ADMIN)

                        // Endpoints Protegidos (Cualquier usuario logueado vía JWT)
                        .requestMatchers(HttpMethod.POST, "/api/v1/comercios", "/api/v1/promociones", "/api/v1/resenas")
                        .authenticated()
